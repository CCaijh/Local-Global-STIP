...
parser.add_argument('--data_test_path', type=str, default='data/human36m/test.txt')
...
parser.add_argument('--pretrained_model_pm', type=str, default='pretrained_model/human36m/model_pm.ckpt-1')
parser.add_argument('--pretrained_model_d', type=str, default='pretrained_model/human36m/model_d.ckpt-1')
parser.add_argument('--perforamnce_dir', type=str, default='results/human36m/')
parser.add_argument('--save_dir', type=str, default='')
parser.add_argument('--gen_frm_dir', type=str, default='results/human36m/')
