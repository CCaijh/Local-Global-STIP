...
parser.add_argument('--data_test_path', type=str, default='data/sjtu4k/test.txt')
...
parser.add_argument('--img_height', type=int, default=2176)
parser.add_argument('--img_width', type=int, default=3840)
...
parser.add_argument('--dataset', type=str, default='sjtu4k')
...
parser.add_argument('--pretrained_model_pm', type=str, default='pretrained_model/sjtu4k/model_pm.ckpt-1')
parser.add_argument('--pretrained_model_d', type=str, default='pretrained_model/sjtu4k/model_d.ckpt-1')
parser.add_argument('--perforamnce_dir', type=str, default='results/sjtu4k/')
parser.add_argument('--save_dir', type=str, default='')
parser.add_argument('--gen_frm_dir', type=str, default='results/sjtu4k/')
