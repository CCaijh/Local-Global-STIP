...
parser.add_argument('--pretrained_model_pm', type=str, default='pretrained_model/ucfsport/model_pm.ckpt-1')
parser.add_argument('--pretrained_model_d', type=str, default='pretrained_model/ucfsport/model_d.ckpt-1')
